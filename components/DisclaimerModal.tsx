...
export default function DisclaimerModal() {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="mx-auto w-full max-w-md rounded-xl border border-[#C9A84C]/20 p-4 text-white shadow-2xl max-h-[90vh] overflow-y-auto" style={{ background: 'linear-gradient(160deg, #0e0d1a 0%, #09090f 100%)' }}>
        <div className="text-sm leading-relaxed mb-4">
          ...
          <div className="bg-gradient-to-r from-red-900/30 to-[#0A0A0F]/30 border-2 border-red-500/50 rounded-lg p-3 mt-4">
          ...
          <button 
            ...
            className={`w-full py-3 rounded-lg text-sm font-bold transition-all hover:scale-105 active:scale-95 ${
              isOver18 && understandsRisks
                ? 'bg-gradient-to-r from-[#C9A84C] to-[#e8c97a] text-black cursor-pointer'
